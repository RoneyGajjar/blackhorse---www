                ...
                <div className="flex flex-col md:flex-row w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                            <button data-cal-namespace="15min" data-cal-link="black-horse-associates-yce8pc/15min" data-cal-config='{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}'
                    ...
                    <div className="flex justify-center items-center hidden md:block md:w-1/2">
                        <img src="/hero-img.webp" alt="" className="w-full h-150 object-cover opacity-80" />
                    </div>
                </div>
            </section>
        </>
